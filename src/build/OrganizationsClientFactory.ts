...
import { OrganizationsMockClientV1 } from '../version1/OrganizationsMockClientV1';
...
export class OrganizationsClientFactory extends Factory {
	...
	public static MockClientV1Descriptor = new Descriptor('service-organizations', 'client', 'mock', 'default', '1.0');
	...
	constructor() {
		...
		this.registerAsType(OrganizationsClientFactory.MockClientV1Descriptor, OrganizationsMockClientV1);
