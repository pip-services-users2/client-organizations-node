...
import { OrganizationsGrpcServiceV1 } from 'service-organizations-node';
import { OrganizationsGrpcClientV1 } from '../../src/version1/OrganizationsGrpcClientV1';
...
suite('OrganizationsGrpcClientV1', ()=> {
    let service: OrganizationsGrpcServiceV1;
    let client: OrganizationsGrpcClientV1;
    ...
    suiteSetup(async () => {
        ...
        client = new OrganizationsGrpcClientV1();
